...
echo "✅ Artifacts Downloaded"download-release-artifacts.sh
...
cd "${DOWNLOAD_LOCATION}/grails-github-actions/tests/gradle-bootstrap"
gradle
echo "✅ Gradle Bootstrapped"

echo "Applying License Audit ..."
cd "${DOWNLOAD_LOCATION}/grails-github-actions/tests"
./gradlew rat
echo "✅ RAT passed"
